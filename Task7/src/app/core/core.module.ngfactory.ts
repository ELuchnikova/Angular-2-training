...
import * as import41 from '@angular/http/src/backends/browser_xhr';
import * as import42 from '@angular/http/src/base_response_options';
import * as import43 from '@angular/http/src/backends/xhr_backend';
import * as import44 from '@angular/http/src/base_request_options';
import * as import45 from '@angular/material/core/gestures/gesture-config';
import * as import46 from '@angular/core/src/di/injector';
import * as import47 from '../../../node_modules/@angular/material/dialog/dialog-container.ngfactory';
import * as import48 from '../../../node_modules/@angular/material/snack-bar/snack-bar-container.ngfactory';
import * as import49 from '../../../node_modules/@angular/material/snack-bar/simple-snack-bar.ngfactory';
import * as import50 from '../../../node_modules/@angular/material/tooltip/tooltip.ngfactory';
...
class CoreModuleInjector extends import0.NgModuleInjector<import1.CoreModule> {
  ...
  _CoreModule_37:import1.CoreModule;
  __NgLocalization_38:import39.NgLocaleLocalization;
  __MATERIAL_COMPATIBILITY_MODE_39:any;
  __RadioControlRegistry_40:import40.RadioControlRegistry;
  __BrowserXhr_41:import41.BrowserXhr;
  __ResponseOptions_42:import42.BaseResponseOptions;
  __XSRFStrategy_43:any;
  __XHRBackend_44:import43.XHRBackend;
  __RequestOptions_45:import44.BaseRequestOptions;
  __Http_46:any;
  __HAMMER_GESTURE_CONFIG_47:import45.GestureConfig;
  ...
  get _NgLocalization_38():import39.NgLocaleLocalization {
    if ((this.__NgLocalization_38 == null)) { (this.__NgLocalization_38 = new import39.NgLocaleLocalization(this.parent.get(import51.LOCALE_ID))); }
    return this.__NgLocalization_38;
  }
  get _MATERIAL_COMPATIBILITY_MODE_39():any {
    if ((this.__MATERIAL_COMPATIBILITY_MODE_39 == null)) { (this.__MATERIAL_COMPATIBILITY_MODE_39 = false); }
    return this.__MATERIAL_COMPATIBILITY_MODE_39;
  }
  get _RadioControlRegistry_40():import40.RadioControlRegistry {
    if ((this.__RadioControlRegistry_40 == null)) { (this.__RadioControlRegistry_40 = new import40.RadioControlRegistry()); }
    return this.__RadioControlRegistry_40;
  }
  get _BrowserXhr_41():import41.BrowserXhr {
    if ((this.__BrowserXhr_41 == null)) { (this.__BrowserXhr_41 = new import41.BrowserXhr()); }
    return this.__BrowserXhr_41;
  }
  get _ResponseOptions_42():import42.BaseResponseOptions {
    if ((this.__ResponseOptions_42 == null)) { (this.__ResponseOptions_42 = new import42.BaseResponseOptions()); }
    return this.__ResponseOptions_42;
  }
  get _XSRFStrategy_43():any {
    if ((this.__XSRFStrategy_43 == null)) { (this.__XSRFStrategy_43 = import19._createDefaultCookieXSRFStrategy()); }
    return this.__XSRFStrategy_43;
  }
  get _XHRBackend_44():import43.XHRBackend {
    if ((this.__XHRBackend_44 == null)) { (this.__XHRBackend_44 = new import43.XHRBackend(this._BrowserXhr_41,this._ResponseOptions_42,this._XSRFStrategy_43)); }
    return this.__XHRBackend_44;
  }
  get _RequestOptions_45():import44.BaseRequestOptions {
    if ((this.__RequestOptions_45 == null)) { (this.__RequestOptions_45 = new import44.BaseRequestOptions()); }
    return this.__RequestOptions_45;
  }
  get _Http_46():any {
    if ((this.__Http_46 == null)) { (this.__Http_46 = import19.httpFactory(this._XHRBackend_44,this._RequestOptions_45)); }
    return this.__Http_46;
  }
  get _HAMMER_GESTURE_CONFIG_47():import45.GestureConfig {
    if ((this.__HAMMER_GESTURE_CONFIG_47 == null)) { (this.__HAMMER_GESTURE_CONFIG_47 = new import45.GestureConfig()); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.CoreModule)) { return this._CoreModule_37; }
    if ((token === import39.NgLocalization)) { return this._NgLocalization_38; }
    if ((token === import3.MATERIAL_COMPATIBILITY_MODE)) { return this._MATERIAL_COMPATIBILITY_MODE_39; }
    if ((token === import40.RadioControlRegistry)) { return this._RadioControlRegistry_40; }
    if ((token === import41.BrowserXhr)) { return this._BrowserXhr_41; }
    if ((token === import42.ResponseOptions)) { return this._ResponseOptions_42; }
    if ((token === import52.XSRFStrategy)) { return this._XSRFStrategy_43; }
    if ((token === import43.XHRBackend)) { return this._XHRBackend_44; }
    if ((token === import44.RequestOptions)) { return this._RequestOptions_45; }
    if ((token === import53.Http)) { return this._Http_46; }
    if ((token === import54.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_47; }
