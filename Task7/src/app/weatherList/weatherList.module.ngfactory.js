...
var import1 = require("./weatherList.module");
...
var import39 = require("../shared/shared.module");
var import40 = require("@angular/common/src/localization");
var import41 = require("@angular/forms/src/directives/radio_control_value_accessor");
var import42 = require("@angular/http/src/backends/browser_xhr");
var import43 = require("@angular/http/src/base_response_options");
var import44 = require("@angular/http/src/backends/xhr_backend");
var import45 = require("@angular/http/src/base_request_options");
var import46 = require("@angular/material/core/gestures/gesture-config");
var import47 = require("../../services/weatherService");
var import49 = require("../../../node_modules/@angular/material/dialog/dialog-container.ngfactory");
var import50 = require("../../../node_modules/@angular/material/snack-bar/snack-bar-container.ngfactory");
var import51 = require("../../../node_modules/@angular/material/snack-bar/simple-snack-bar.ngfactory");
var import52 = require("../../../node_modules/@angular/material/tooltip/tooltip.ngfactory");
var import53 = require("@angular/core/src/i18n/tokens");
var import54 = require("@angular/http/src/interfaces");
var import55 = require("@angular/http/src/http");
var import56 = require("@angular/platform-browser/src/dom/events/hammer_gestures");
var WeatherListModuleInjector = (function (_super) {
    __extends(WeatherListModuleInjector, _super);
    function WeatherListModuleInjector(parent) {
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_NgLocalization_39", {
        get: function () {
            if ((this.__NgLocalization_39 == null)) {
                (this.__NgLocalization_39 = new import40.NgLocaleLocalization(this.parent.get(import53.LOCALE_ID)));
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_RadioControlRegistry_40", {
        get: function () {
            if ((this.__RadioControlRegistry_40 == null)) {
                (this.__RadioControlRegistry_40 = new import41.RadioControlRegistry());
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_MATERIAL_COMPATIBILITY_MODE_41", {
        get: function () {
            if ((this.__MATERIAL_COMPATIBILITY_MODE_41 == null)) {
                (this.__MATERIAL_COMPATIBILITY_MODE_41 = false);
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_BrowserXhr_42", {
        get: function () {
            if ((this.__BrowserXhr_42 == null)) {
                (this.__BrowserXhr_42 = new import42.BrowserXhr());
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_ResponseOptions_43", {
        get: function () {
            if ((this.__ResponseOptions_43 == null)) {
                (this.__ResponseOptions_43 = new import43.BaseResponseOptions());
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_XSRFStrategy_44", {
        get: function () {
            if ((this.__XSRFStrategy_44 == null)) {
                (this.__XSRFStrategy_44 = import19._createDefaultCookieXSRFStrategy());
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_XHRBackend_45", {
        get: function () {
            if ((this.__XHRBackend_45 == null)) {
                (this.__XHRBackend_45 = new import44.XHRBackend(this._BrowserXhr_42, this._ResponseOptions_43, this._XSRFStrategy_44));
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_RequestOptions_46", {
        get: function () {
            if ((this.__RequestOptions_46 == null)) {
                (this.__RequestOptions_46 = new import45.BaseRequestOptions());
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_Http_47", {
        get: function () {
            if ((this.__Http_47 == null)) {
                (this.__Http_47 = import19.httpFactory(this._XHRBackend_45, this._RequestOptions_46));
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_HAMMER_GESTURE_CONFIG_48", {
        get: function () {
            if ((this.__HAMMER_GESTURE_CONFIG_48 == null)) {
                (this.__HAMMER_GESTURE_CONFIG_48 = new import46.GestureConfig());
            }
    ...
    Object.defineProperty(WeatherListModuleInjector.prototype, "_WeatherService_49", {
        get: function () {
            if ((this.__WeatherService_49 == null)) {
                (this.__WeatherService_49 = new import47.WeatherService());
            }
    ...
    WeatherListModuleInjector.prototype.createInternal = function () {
    ...
    WeatherListModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import39.SharedModule)) {
            return this._SharedModule_37;
        }
        if ((token === import1.WeatherListModule)) {
            return this._WeatherListModule_38;
        }
        if ((token === import40.NgLocalization)) {
            return this._NgLocalization_39;
        }
        if ((token === import41.RadioControlRegistry)) {
            return this._RadioControlRegistry_40;
        }
        if ((token === import5.MATERIAL_COMPATIBILITY_MODE)) {
            return this._MATERIAL_COMPATIBILITY_MODE_41;
        }
        if ((token === import42.BrowserXhr)) {
            return this._BrowserXhr_42;
        }
        if ((token === import43.ResponseOptions)) {
            return this._ResponseOptions_43;
        }
        if ((token === import54.XSRFStrategy)) {
            return this._XSRFStrategy_44;
        }
        if ((token === import44.XHRBackend)) {
            return this._XHRBackend_45;
        }
        if ((token === import45.RequestOptions)) {
            return this._RequestOptions_46;
        }
        if ((token === import55.Http)) {
            return this._Http_47;
        }
        if ((token === import56.HAMMER_GESTURE_CONFIG)) {
            return this._HAMMER_GESTURE_CONFIG_48;
        }
        if ((token === import47.WeatherService)) {
            return this._WeatherService_49;
        }
        return notFoundResult;
    };
    WeatherListModuleInjector.prototype.destroyInternal = function () {
    };
    return WeatherListModuleInjector;
}(import0.NgModuleInjector));
exports.WeatherListModuleNgFactory = new import0.NgModuleFactory(WeatherListModuleInjector, import1.WeatherListModule);
//# sourceMappingURL=weatherList.module.ngfactory.js.map